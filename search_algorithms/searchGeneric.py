...
class Searcher(Displayable):
    ...
    def search(self):
        ...
        while not self.empty_frontier():
            node_cost, path = self.frontier.pop()              #I modified this part: to keep the cost
            ...
            if self.problem.is_goal(path.end()):    # solution found
                ...
                return (node_cost, path.end())          #I modified this part: to return the cost and just the final solution
            else:
...
class FrontierPQ(object):
    ...
    * path is the path on the queue
    ...
    def pop(self):
        ...
        """
        (i,_,path) = heapq.heappop(self.frontierpq)  #I modified this part to keep the cost
        return (i,path)  #I modified this part to keep the cost
...
class AStarSearcher(Searcher):
    ...
    def add_to_frontier(self,path):
        ...
        value = self.problem.heuristic(path.end())      #I modified this part to consider just heuristic's cost
